...
export default function App() {
  ...
  const [cabecera, setCabecera] = useState<ReporteTurno>({
    ...
    tension_fleje_cumple: true,
    observacion_tension_fleje: '',
    video_inspector_cumple: true,
    observacion_video_inspector: '',
    light_tester_cumple: true,
    observacion_light_tester: '',
    printer_11_calificacion: 'No Aplica',
    observacion_printer_11: '',
    printer_12_calificacion: 'No Aplica',
    observacion_printer_12: '',
    printer_31_calificacion: 'No Aplica',
    observacion_printer_31: '',
    printer_32_calificacion: 'No Aplica',
