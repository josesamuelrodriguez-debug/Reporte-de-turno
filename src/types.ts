...
export interface ReporteTurno {
  ...
  tension_fleje_cumple?: boolean;
  observacion_tension_fleje?: string;
  video_inspector_cumple?: boolean;
  observacion_video_inspector?: string;
  light_tester_cumple?: boolean;
  observacion_light_tester?: string;
  printer_11_calificacion?: 'Cumple' | 'No Cumple' | 'No Aplica';
  observacion_printer_11?: string;
  printer_12_calificacion?: 'Cumple' | 'No Cumple' | 'No Aplica';
  observacion_printer_12?: string;
  printer_31_calificacion?: 'Cumple' | 'No Cumple' | 'No Aplica';
  observacion_printer_31?: string;
  printer_32_calificacion?: 'Cumple' | 'No Cumple' | 'No Aplica';
  observacion_printer_32?: string;
